var Timeline = function (container, date) {
    ...
    this.monthsOfYear = ["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月"];
    this.dayNumbers = {
        "sunday": 0,
        "monday": 1,
        "tuesday": 2,
    ...
    this.renderDay = function (topRow, bottomRow, data) {
        ...
        topRow.append("<li><div >" + data.name + "</div></li>");
    ...
    this.setupArrows = function () {
        var dateString = + this.date.getFullYear() + "年"+this.monthsOfYear[this.date.getMonth()] ;
        var html = "";
        html += "<div  title=\"Previous Year\"></div>"
    ...
    this.getMonthRepresentation = function () {
        ...
        for (var i = 0; i < numberOfDays; i++) {
            result.push({
                name: this.weekDays[firstDay].substring(0, 0),
